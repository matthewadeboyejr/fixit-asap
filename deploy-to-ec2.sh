INSTANCE_ID="i-02d6504006ba78ce5"
APP_CONTAINER_NAME="fixitapp"
...
CONTAINER_START_COMMAND="docker run -d --restart unless-stopped -p 80:3001 --name $APP_CONTAINER_NAME $APP_CONTAINER_IMAGE"
